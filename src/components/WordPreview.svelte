...
const myWords = [
    { word: "Word0", size: 400, is_not_risk: true },
    { word: "Word1", size: 300, is_not_risk: true },
    { word: "Word2", size: 190, is_not_risk: false },
    { word: "Word3", size: 198, is_not_risk: true },
    { word: "Word4", size: 150, is_not_risk: true },
